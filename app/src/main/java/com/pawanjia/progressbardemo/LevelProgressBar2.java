...
public class LevelProgressBar2 extends View {
    ...
    public LevelProgressBar2(Context context) {
        this(context, null);
    }

    public LevelProgressBar2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LevelProgressBar2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     * @return
     */
    public LevelProgressBar2 setMaxValue(int maxValue) {
        if (0 < maxValue) {
     ...
     * @return
     */
    public LevelProgressBar2 setProgress(int currentProgress) {
